package com.example.msmorenoalva.infraestructure.adapters;

import com.example.msmorenoalva.domain.aggregates.constants.Constants;
...
import com.example.msmorenoalva.infraestructure.mapper.PersonaMapper;
import com.example.msmorenoalva.infraestructure.repository.PersonaRepository;
import com.example.msmorenoalva.infraestructure.repository.TipoDocumentoRepository;
import com.example.msmorenoalva.infraestructure.repository.TipoPersonaRepository;
...
public class PersonaAdapter implements PersonaServiceOut {
    ...
    @Override
    public Optional<PersonaDTO> obtenerPersonaOut(String numero) {
        return Optional.ofNullable(personaMapper.mapToDto(personaRepository.findByNumDocu(numero).get()));
    }

    @Override
    public Optional<PersonaDTO> obtenerPersonaIdOut(Long id) {
